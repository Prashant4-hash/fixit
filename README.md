...
> ?? **[Download Complete Technical Documentation (Word Document)](https://github.com/Prashant4-hash/fixit/raw/main/FixIt_CLI_Project_Documentation.docx)**
...
2. Add the `fixit` function to your PowerShell `$PROFILE`.
